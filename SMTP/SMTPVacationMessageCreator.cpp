...
namespace HM
{
                                        ...
                                        const std::shared_ptr<Message> pOriginalMessage)
   {
      ...
      if (sModifiedSubject.Find(PLATFORM_STRING("%")) >= 0 || sModifiedBody.Find(PLATFORM_STRING("%")) >= 0)
      {
         ...
         sModifiedSubject.ReplaceNoCase(PLATFORM_STRING("%SUBJECT%"), sOldSubject);
         sModifiedBody.ReplaceNoCase(PLATFORM_STRING("%SUBJECT%"), sOldSubject);
      }
