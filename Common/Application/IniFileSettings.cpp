...
namespace HM
{
   ...
   //---------------------------------------------------------------------------()
   {
      ...
      if (sDatabaseType.CompareNoCase(PLATFORM_STRING("MSSQL")) == 0)
         sqldbtype_ = HM::DatabaseSettings::TypeMSSQLServer;
      else if (sDatabaseType.CompareNoCase(PLATFORM_STRING("MYSQL")) == 0)
         sqldbtype_ = HM::DatabaseSettings::TypeMYSQLServer;
      else if (sDatabaseType.CompareNoCase(PLATFORM_STRING("PostgreSQL")) == 0)
         sqldbtype_ = HM::DatabaseSettings::TypePGServer;
      else if (sDatabaseType.CompareNoCase(PLATFORM_STRING("MSSQLCE")) == 0)
      ...
      if (app_directory_.Right(1) != PLATFORM_STRING("\\"))
         app_directory_ += "\\";

      data_directory_ = ReadIniSettingString_("Directories", "DataFolder", "");
      if (data_directory_.Right(1) == PLATFORM_STRING("\\"))
      ...
      if (temp_directory_.Right(1) == PLATFORM_STRING("\\"))
      ...
      if (dbscript_directory_.Right(1) != PLATFORM_STRING("\\"))
         dbscript_directory_ += "\\";
      ...
      if (database_directory_.Right(1) == PLATFORM_STRING("\\"))
      ...
      if (archive_dir_.Right(1) == PLATFORM_STRING("\\"))
   ...
   IniFileSettings::GetInitializationFile() 
   {
      if (ini_file_.IsEmpty())
      {
         ...
         if (ini_file_.Right(1) != PLATFORM_STRING("\\"))
            ini_file_ += "\\";
   ...
   { 
      ...
      {
         TCHAR Value[255];
         GetPrivateProfileString( PLATFORM_STRING("Directories"), PLATFORM_STRING("LogFolder"), PLATFORM_STRING(""), Value, 255, GetInitializationFile() );
   ...
   IniFileSettings::CheckSettings(String &sErrorMessage)
   {
      ...
      String sLog;
      sLog.Format(PLATFORM_STRING("Configuration::CheckSettings - %s"), sIniFile.c_str());
      LOG_DEBUG(sLog);
      ...
      case HM::DatabaseSettings::TypeMSSQLCompactEdition:
         {
            ...
            {
               sErrorMessage.Format(PLATFORM_STRING("The setting Database in the section Database could not be read from %s"), sIniFile.c_str());
               return false;
            }
            break;
         }
      default:
         {
            ...
            {
               sErrorMessage.Format(PLATFORM_STRING("The setting Server in the section Database could not be read from %s"), sIniFile.c_str());
               return false;
            }
            break;
         }
   ...
   IniFileSettings::GetUserInterfaceLanguage()
   {
      ...
      GetPrivateProfileString( PLATFORM_STRING("Settings"), PLATFORM_STRING("UseLanguage"), PLATFORM_STRING("English"), Value, 255, GetInitializationFile() );
      return Value;
   ...
   {
      WritePrivateProfileString(PLATFORM_STRING("Settings"), PLATFORM_STRING("UseLanguage"), sLanguage, GetInitializationFile());
   }
   ...
   //---------------------------------------------------------------------------()
   {
      ...
      case HM::DatabaseSettings::TypeMSSQLServer:
          sDatabaseType = PLATFORM_STRING("MSSQL");
          break;
      case HM::DatabaseSettings::TypeMYSQLServer:
         sDatabaseType = PLATFORM_STRING("MYSQL");
         break;
      case HM::DatabaseSettings::TypePGServer:
         sDatabaseType = PLATFORM_STRING("PostgreSQL");
         break;
      case HM::DatabaseSettings::TypeMSSQLCompactEdition:
         sDatabaseType = PLATFORM_STRING("MSSQLCE");
         break;
      default:
         return;
      }
