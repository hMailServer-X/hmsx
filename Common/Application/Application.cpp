...
#include "../TCPIP/hRMS/hRMS_server_main.h"
...
namespace HM
{
   ...
   //---------------------------------------------------------------------------()
  {
   ...
   Application::OpenDatabase(String &sErrorMessage)
   {
      ...
      {
         String sError;
         sError.Format(PLATFORM_STRING("Loading of ini file settings failed. Error: %s"), sIniFileCheckError.c_str());
   ...
   Application::OnDatabaseConnected(String &sErrorMessage)
   {
          ...
          || iDBVersion > Configuration::Instance()->GetRequiredDBVersion())
      {
         ...
         String sVersionInfo;
         sVersionInfo.Format(PLATFORM_STRING(" Database version: %d, Required database version: %d"), iDBVersion, Configuration::Instance()->GetRequiredDBVersion());
   ...
   //---------------------------------------------------------------------------()
   {
      ...
      HMODULE handle = GetModuleHandle(PLATFORM_STRING("hmailserver.exe"));
