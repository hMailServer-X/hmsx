...
namespace HM
{
   ...
   public:
      ...
      bool Execute(const SQLCommand &command, String &sErrorMessage, long long *iInsertID = 0, int iIgnoreErrors = 0);

      bool Reconnect(String &sErrorMessage);

      virtual ConnectionResult Connect(String &sErrorMessage) = 0;
      virtual bool Disconnect() = 0;
      virtual ExecutionResult TryExecute(const SQLCommand &command, String &sErrorMessage, long long *iInsertID = 0, int iIgnoreErrors = 0) = 0;
