...
namespace HM
{
   ...
   public:
      ...
      static bool LockObject(long long ObjectID);
      ...
      static bool GetMessageID(const String &fileName, long long &messageID, bool &isPartialFilename);
      static bool ReadObject(std::shared_ptr<DALRecordset> pRS, std::shared_ptr<Message> pMessage, bool bReadRecipients = true);
      static bool ReadObject(std::shared_ptr<Message> pMessage, long long ObjectID);
      static bool ReadObject(std::shared_ptr<Message> pMessage, const SQLCommand &command);

      static bool SetNextTryTime(long long iMessageID, bool bUpdateNoOfTries, long lNoOfMinutes);
      ...
      static bool DeleteByAccountID(long long iAccountID);
