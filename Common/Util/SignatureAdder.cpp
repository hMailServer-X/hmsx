   ...
   {  
      ...
      if (sender_account && sender_account->GetEnableSignature())
      {
         ...
         if (!signature_plain_text.IsEmpty() && signature_html.IsEmpty())
         {
            ...
            signature_html.Replace(PLATFORM_STRING("\r\n"), PLATFORM_STRING("<br>\r\n"));
         }
      }
      ...
      if (sender_domain->GetEnableSignature())
      {
         ...
         if (!sDomainPlainText.IsEmpty() && sDomainHTML.IsEmpty())
         {
            ...
            sDomainHTML.Replace(PLATFORM_STRING("\r\n"), PLATFORM_STRING("<br>\r\n"));
         }
      ...
      if (sender_account)
      {
         signature_plain_text.ReplaceNoCase(PLATFORM_STRING("%User.FirstName%"), sender_account->GetPersonFirstName());
         signature_plain_text.ReplaceNoCase(PLATFORM_STRING("%User.LastName%"), sender_account->GetPersonLastName());
         signature_plain_text.ReplaceNoCase(PLATFORM_STRING("%User.Address%"), sender_account->GetAddress());

         signature_html.ReplaceNoCase(PLATFORM_STRING("%User.FirstName%"), sender_account->GetPersonFirstName());
         signature_html.ReplaceNoCase(PLATFORM_STRING("%User.LastName%"), sender_account->GetPersonLastName());
         signature_html.ReplaceNoCase(PLATFORM_STRING("%User.Address%"), sender_account->GetAddress());
      }
