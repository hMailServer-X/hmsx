...
namespace HM
{
   ...
   AddresslistParser::ParseList(const String &sList) const
   {
      ...
      for(String compound : vecCompounds)
      {
         ...
         sMailbox.Replace(PLATFORM_STRING("<"), PLATFORM_STRING(""));      
         sDomain.Replace(PLATFORM_STRING(">"), PLATFORM_STRING(""));
   ...
   AddresslistParser::ExtractParts(const String &sCompound, String &sFullName, String &sMailbox, String &sDomain) const
   {
      ...
      if (sFullName.IsEmpty())
      {
         ...
         int iGTPos = sCompound.Find(PLATFORM_STRING("<"));
   ...
   {
      TheString.Replace(PLATFORM_STRING("\\\""), PLATFORM_STRING("\""));
      TheString.Replace(PLATFORM_STRING("\\\\"), PLATFORM_STRING("\\"));
   }
   ...
   AddresslistParserTester::Test()
   {
      ...
      {  // MORE ADVANCED
         ...
         if ((*iterFirst)->sPersonalName != PLATFORM_STRING("Test2 Testar"))
         {
            assert(0);
            throw;
         }

         if ((*iterFirst)->sMailboxName != PLATFORM_STRING("testa"))
         {
            assert(0);
            throw;
         }

         if ((*iterFirst)->sDomainName != PLATFORM_STRING("testy.com"))
         {
            assert(0);
            throw;
         }
      ...
      {  // EVEN MORE ADVANCED. Two addresses without <> around the addresses.
         ...
         if ((*iterFirst)->sPersonalName != PLATFORM_STRING("Martin Knafve"))
         {
            assert(0);
            throw;
         }

         if ((*iterFirst)->sMailboxName != PLATFORM_STRING("martin"))
         {
            assert(0);
            throw;
         }

         if ((*iterFirst)->sDomainName != PLATFORM_STRING("test.com"))
         {
            assert(0);
            throw;
         }
      ...
      {  // EVEN EVEN MORE ADVANCED. Two addresses without "" around the names.
         ...
         if ((*iterFirst)->sPersonalName != PLATFORM_STRING("MartinKnafve"))
         {
            assert(0);
            throw;
         }
         ...
         if ((*iterFirst)->sPersonalName != PLATFORM_STRING("EyyAo"))
         {
            assert(0);
            throw;
         }
...

      {
         ...
         if ((*iterFirst)->sMailboxName != PLATFORM_STRING("webmaster"))
            throw;

         if ((*iterFirst)->sDomainName != PLATFORM_STRING("phiphi.org"))
            throw;
      ...
      {  // SUPER advanced...
         ...
         if ((*iterFirst)->sPersonalName != PLATFORM_STRING("Kalle"))
         {
            assert(0);
            throw;
         }

         if ((*iterFirst)->sMailboxName != PLATFORM_STRING(""))
         {
            assert(0);
            throw;
         }

         if ((*iterFirst)->sDomainName != PLATFORM_STRING(""))
         {
            assert(0);
            throw;
         }
