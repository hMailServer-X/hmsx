...
namespace HM
{
   ...
   Time::GetCurrentDateTime() 
   {
      ...
      String sValue;
      sValue.Format(PLATFORM_STRING("%d-%.02d-%.02d %.02d:%.02d:%.02d"), pTime.wYear, pTime.wMonth, pTime.wDay, pTime.wHour, pTime.wMinute, pTime.wSecond );
      return sValue;
   }
   ...
   Time::GetCurrentDateTimeWithMilliseconds() 
   {
      ...
      String sValue;
      sValue.Format(PLATFORM_STRING("%d-%.02d-%.02d %.02d:%.02d:%.02d.%.03d"), pTime.wYear, pTime.wMonth, pTime.wDay, pTime.wHour, pTime.wMinute, pTime.wSecond, pTime.wMilliseconds );
      return sValue;
   }
   ...
   Time::GetCurrentDate() 
   {
      ...
      String sValue;
      sValue.Format(PLATFORM_STRING("%d-%.02d-%.02d"), pTime.wYear, pTime.wMonth, pTime.wDay);
   ...
   Time::GetTimeStampFromDateTime(const DateTime &dt) 
   {
      ...
      String sValue;
      sValue.Format(PLATFORM_STRING("%d-%.02d-%.02d %.02d:%.02d:%.02d"), dt.GetYear(), dt.GetMonth(), dt.GetDay(), dt.GetHour(), dt.GetMinute(), dt.GetSecond() );
      return sValue;
   }
   ...
   Time::GetUTCRelation()
   {
     ...
     if (totalMinutes < 0)
        sRetVal.Format(PLATFORM_STRING("-%0.2d%0.2d"), hours, remainingMinutes);
     else
        sRetVal.Format(PLATFORM_STRING("+%0.2d%0.2d"), hours, remainingMinutes);
   ...
   //---------------------------------------------------------------------------()   
   {
      ...
      else if (sTimeZone == PLATFORM_STRING("UT") || sTimeZone == PLATFORM_STRING("GMT"))
         iHours = 0;
      else if (sTimeZone == PLATFORM_STRING("EST"))
         iHours = 5;
      else if (sTimeZone ==PLATFORM_STRING( "EDT"))
         iHours = 4;
      else if (sTimeZone == PLATFORM_STRING("CST"))
         iHours = 6;
      else if (sTimeZone == PLATFORM_STRING("CDT"))
         iHours = 5;
      else if (sTimeZone == PLATFORM_STRING("MST"))
         iHours = 7;
      else if (sTimeZone == PLATFORM_STRING("MDT"))
         iHours = 6;
      else if (sTimeZone == PLATFORM_STRING("PST"))
         iHours = 8;
      else if (sTimeZone == PLATFORM_STRING("CET"))
         iHours = -1;
      else if (sTimeZone == PLATFORM_STRING("MET"))
         iHours = -1;
      else if (sTimeZone == PLATFORM_STRING("PDT"))
         iHours = 7;
      else 
      {
         return false;
   ...
   Time::GetCurrentMimeDate()
   {
      ...
      String sResult;
      sResult.Format(PLATFORM_STRING("%s, %d %s %d %.02d:%.02d:%.02d %s"),
   ...
   //---------------------------------------------------------------------------()   
   {
      ...
      String sResult;
      sResult.Format(PLATFORM_STRING("%s-%s-%s"), sDay.c_str(), sMonth.c_str(), sYear.c_str());
   ...
   //---------------------------------------------------------------------------()   
   {
      ...
      sDate.Replace(PLATFORM_STRING("  "), PLATFORM_STRING(" "));
   ...
   //---------------------------------------------------------------------------()   
   {
      ...
      if (sDay.Left(1) == PLATFORM_STRING("0"))
         sDay = " " + sDay.Mid(1);
      ...
      String sResult;
      sResult.Format(PLATFORM_STRING("%s-%s-%s %s %s"), 
   ...
   Time::GetInternalDateFromIMAPInternalDate(const String &sMIMEDate)
   {
      ...
      sResult.Format(PLATFORM_STRING("%04d-%.02d-%.02d %.02d:%.02d:%.02d"), 
   ...
   {
      if (sMonth.CompareNoCase(PLATFORM_STRING("JAN")) == 0)
         return 1;
      if (sMonth.CompareNoCase(PLATFORM_STRING("FEB")) == 0)
         return 2;
      if (sMonth.CompareNoCase(PLATFORM_STRING("MAR")) == 0)
         return 3;
      if (sMonth.CompareNoCase(PLATFORM_STRING("APR")) == 0)
         return 4;
      if (sMonth.CompareNoCase(PLATFORM_STRING("MAY")) == 0)
         return 5;
      if (sMonth.CompareNoCase(PLATFORM_STRING("JUN")) == 0)
         return 6;
      if (sMonth.CompareNoCase(PLATFORM_STRING("JUL")) == 0)
         return 7;
      if (sMonth.CompareNoCase(PLATFORM_STRING("AUG")) == 0)
         return 8;
      if (sMonth.CompareNoCase(PLATFORM_STRING("SEP")) == 0)
         return 9;
      if (sMonth.CompareNoCase(PLATFORM_STRING("OCT")) == 0)
         return 10;
      if (sMonth.CompareNoCase(PLATFORM_STRING("NOV")) == 0)
         return 11;
      if (sMonth.CompareNoCase(PLATFORM_STRING("DEC")) == 0)
         return 12;

      if (sMonth.CompareNoCase(PLATFORM_STRING("January")) == 0)
         return 1;
      if (sMonth.CompareNoCase(PLATFORM_STRING("February")) == 0)
         return 2;
      if (sMonth.CompareNoCase(PLATFORM_STRING("March")) == 0)
         return 3;
      if (sMonth.CompareNoCase(PLATFORM_STRING("April")) == 0)
         return 4;
      if (sMonth.CompareNoCase(PLATFORM_STRING("May")) == 0)
         return 5;
      if (sMonth.CompareNoCase(PLATFORM_STRING("June")) == 0)
         return 6;
      if (sMonth.CompareNoCase(PLATFORM_STRING("July")) == 0)
         return 7;
      if (sMonth.CompareNoCase(PLATFORM_STRING("August")) == 0)
         return 8;
      if (sMonth.CompareNoCase(PLATFORM_STRING("September")) == 0)
         return 9;
      if (sMonth.CompareNoCase(PLATFORM_STRING("October")) == 0)
         return 10;
      if (sMonth.CompareNoCase(PLATFORM_STRING("November")) == 0)
         return 11;
      if (sMonth.CompareNoCase(PLATFORM_STRING("December")) == 0)
         return 12;
