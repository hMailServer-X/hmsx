...
namespace HM
{
   ...
   Base64Tester::Test()
   {
      ...
      if (s.Compare(PLATFORM_STRING("VGVzdA==")) != 0)
         throw;

      input = "Test test test test test test test!!!!";
      s = Base64::Encode(input, input.GetLength());
      if (s.Compare(PLATFORM_STRING("VGVzdCB0ZXN0IHRlc3QgdGVzdCB0ZXN0IHRlc3QgdGVzdCEhISE=")) != 0)
         throw;
      ...
      s = Base64::Encode(input, input.GetLength());
      if (s.Compare(PLATFORM_STRING("")) != 0)
         throw;
      ...
      s = Base64::Decode(input, input.GetLength());
      if (s.Compare(PLATFORM_STRING("Test test test test test test test!!!!")) != 0)
         throw;
