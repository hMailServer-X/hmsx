...
namespace HM
{
   ...
   public:
      ...
      long long GetAccountID() const { return message_account_id_; }
      void SetAccountID(long long MsgAccountID) { message_account_id_ = (int) MsgAccountID; }
      ...
      long long GetFolderID() const { return message_folder_id_; }
      void SetFolderID(long long iFolderID) { message_folder_id_ = (int) iFolderID; }
