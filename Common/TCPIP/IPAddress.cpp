...
namespace HM
{
   ...
   IPAddress::IPAddress(long long address1)
   {
      SetIPV4Address_(address1);
   }

   IPAddress::IPAddress(long long address1, long long address2)
   {
   ...
   IPAddress::TryParse(const AnsiString &addressString, bool reportOnFail)
   {
      ...
      if (error)
      {
         if (reportOnFail)
         {
            ...
            formattedMessage.Format(PLATFORM_STRING("Unable to parse TCP/IP address. Address: %s, Error code: %d, Error message: %s"), String(addressString).c_str(), error.value(), String(error.message()).c_str());
   ...
   void 
   IPAddress::SetIPV4Address_(long long address1)
   {
   ...
   void 
   IPAddress::SetIPV6Address_(long long address1, long long address2)
   {
   ...
   IPAddress::GetAddress1() const
   {
      if (address_.is_v4())
      {
         ...
         long long ret = 0xFFFFFFFF & ((bytes_value[0] << 24) | (bytes_value[1] << 16) | (bytes_value[2] << 8) | bytes_value[3]);
      ...
      else if (address_.is_v6())
      {
         ...
         unsigned long long ret = 0xFFFFFFFFFFFFFFFF & (long long) bytes_value[0] << 56;
         ret |=  (long long) bytes_value[1] << 48;
         ret |=  (long long) bytes_value[2] << 40;
         ret |=  (long long) bytes_value[3] << 32;
         ret |=  (long long) bytes_value[4] << 24;
         ret |=  (long long) bytes_value[5] << 16;
         ret |=  (long long) bytes_value[6] << 8;
         ret |=  (long long) bytes_value[7] << 0;
   ...
   IPAddress::GetAddress2() const
   {
      ...
      else if (address_.is_v6())
      {
         ...
         unsigned long long ret = 0xFFFFFFFFFFFFFFFF & (long long) bytes_value[8] << 56;
         ret |=  (long long) bytes_value[9] << 48;
         ret |=  (long long) bytes_value[10] << 40;
         ret |=  (long long) bytes_value[11] << 32;
         ret |=  (long long) bytes_value[12] << 24;
         ret |=  (long long) bytes_value[13] << 16;
         ret |=  (long long) bytes_value[14] << 8;
         ret |=  (long long) bytes_value[15] << 0;
   ...
   IPAddress::WithinRange(const IPAddress &lower, const IPAddress &upper) const
   {
      ...
      unsigned long long addressToCheck1 = GetAddress1();
      unsigned long long addressToCheck2 = GetAddress2();
