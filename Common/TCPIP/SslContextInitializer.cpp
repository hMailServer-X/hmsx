...
namespace HM
{
   ...
   {  
      ...
      catch (boost::system::system_error ec)
      {
         ...
         String errorMessage;
         errorMessage.Format(PLATFORM_STRING("Failed to set SSL context options. Address: %s, Port: %i, Error: %s"), 
      ...
      catch (boost::system::system_error ec)
      {
         ...
         String errorMessage;
         errorMessage.Format(PLATFORM_STRING("Failed to load certificate file. Path: %s, Address: %s, Port: %i, Error: %s"), 
      ...
      catch (boost::system::system_error ec)
      {
         ...
         String errorMessage;
         errorMessage.Format(PLATFORM_STRING("Failed to load certificate chain from certificate file. Path: %s, Address: %s, Port: %i, Error: %s"), 
      ...
      catch (boost::system::system_error ec)
      {
         ...
         String errorMessage;
         errorMessage.Format(PLATFORM_STRING("Failed to load private key file. Path: %s, Address: %s, Port: %i, Error: %s"), 
