...
namespace HM
{
   ...
   IMAPSimpleCommandParser::Parse(std::shared_ptr<IMAPCommandArgument> pArgument)
   {
      ...
      while (1)
      {
         ...
         {
            iCurWordEndPos = sCommand.Find(PLATFORM_STRING("}"), iCurWordStartPos);
   ...
   */
   ...
   IMAPSimpleCommandParserTester::Test()
   {
      {  //  LIST "PARAM1" "PARAM2"
         ...
         if (pParser->Word(1)->Value() != PLATFORM_STRING("PARAM1") || pParser->Word(2)->Value() != PLATFORM_STRING("PARAM2"))
         {
            assert(0);
            throw;
         }
      ...
      {  //  LIST "PARAM1"
         ...
         if (pParser->Word(1)->Value() != PLATFORM_STRING("PARAM1"))
         {
            assert(0);
            throw;
         }
      ...
      {  //  LIST PARAMTEST
         ...
         if (pParser->Word(1)->Value() != PLATFORM_STRING("PARAMTEST"))
         {
            assert(0);
            throw;
         }
      ...
      {  //  LIST PARAMTEST
         ...
         if (pParser->Word(2)->Value() != PLATFORM_STRING("I AM SICK"))
         {
            assert(0);
            throw;
         }
      ...
      {  //  LIST PARAMTEST
         ...
         if (pParser->Word(1)->Value() != PLATFORM_STRING("INBOX*"))
         {
            assert(0);
            throw;
         }
      ...
      {  //  LIST PARAMTEST
         ...
         if (pParser->Word(1)->Value() != PLATFORM_STRING("INBOX.\"Hej\""))
         {
            assert(0);
            throw;
         }
      ...
      {  //  PARANTHESE
         ...
         if (pParser->Word(1)->Value() != PLATFORM_STRING("TEST"))
         {
            assert(0);
            throw;
         }
      ...
      {  //  PARANTHESE3
         ...
         if (pParser->Word(1)->Value() != PLATFORM_STRING("\"TE\"()\"ST\""))
         {
            assert(0);
            throw;
         }
