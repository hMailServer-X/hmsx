...
namespace HM
{
   ...
   IMAPConnection::InternalParseData(const AnsiString &Request)
   {
      ...
      int iLineEnd = command_buffer_.Find(PLATFORM_STRING("\r\n"));
      int iSpace = command_buffer_.Find(PLATFORM_STRING(" "));
   ...
   //---------------------------------------------------------------------------()
   {
      if (literal_data_to_receive_ > 0)
      {
         int iCommandStartPos = command_buffer_.Find(PLATFORM_STRING(" "))+1;
         if (command_buffer_.FindNoCase(PLATFORM_STRING("LOGIN")) == iCommandStartPos)
         {
            return true;
         }
      }
   ...
   //---------------------------------------------------------------------------()
   {
      ...
      //
      int iFullCommandStartPos = command_buffer_.Find(PLATFORM_STRING(" "))+1;
      if (command_buffer_.FindNoCase(PLATFORM_STRING("APPEND")) == iFullCommandStartPos)
      {
         // HACK:
         ...
         if (sCommand.FindNoCase(PLATFORM_STRING("APPEND {")) < 0)
         {
      ...
      if (sCommand.Right(1) != PLATFORM_STRING("}"))
         return 0;

      int iParStart = sCommand.ReverseFind(PLATFORM_STRING("{")) + 1;
      int iParEnd = sCommand.Find(PLATFORM_STRING("}"), iParStart);
   ...
   IMAPConnection::SendAsciiData(const AnsiString & sData)
   {
      if (Logger::Instance()->GetLogIMAP())
      {
         ...
         if ((Logger::Instance()->GetLogDebug()) || (log_level_ > 2) || (!(sDataTmp.Find(PLATFORM_STRING("FETCH")) > 0) && !(sDataTmp.Find(PLATFORM_STRING("STATUS")) > 0) && iDataLenTmp >= 5))
         {
            String sLogData = PLATFORM_STRING("SENT: ") + sData;
   ...
   {
      sCommand.ToUpper();
      if (sCommand == PLATFORM_STRING("CAPABILITY"))
         return IMAP_CAPABILITY;
      else if (sCommand == PLATFORM_STRING("LOGIN"))
         return IMAP_LOGIN;
      else if (sCommand == PLATFORM_STRING("LIST"))
         return IMAP_LIST;
      else if (sCommand == PLATFORM_STRING("LSUB"))
         return IMAP_LSUB;
      else if (sCommand == PLATFORM_STRING("SELECT"))
         return IMAP_SELECT;
      else if (sCommand == PLATFORM_STRING("FETCH"))
         return IMAP_FETCH;
      else if (sCommand == PLATFORM_STRING("UID"))
         return IMAP_UID;
      else if (sCommand == PLATFORM_STRING("LOGOUT"))
         return IMAP_LOGOUT;
      else if (sCommand == PLATFORM_STRING("NOOP"))
         return IMAP_NOOP;
      else if (sCommand == PLATFORM_STRING("SUBSCRIBE"))
         return IMAP_SUBSCRIBE;
      else if (sCommand == PLATFORM_STRING("CREATE"))
         return IMAP_CREATE;
      else if (sCommand == PLATFORM_STRING("EXPUNGE"))
         return IMAP_EXPUNGE;
      else if (sCommand == PLATFORM_STRING("DELETE"))
         return IMAP_DELETE;
      else if (sCommand == PLATFORM_STRING("UNSUBSCRIBE"))
         return IMAP_UNSUBSCRIBE;
      else if (sCommand == PLATFORM_STRING("STATUS"))
         return IMAP_STATUS;
      else if (sCommand == PLATFORM_STRING("CLOSE"))
         return IMAP_CLOSE;
      else if (sCommand == PLATFORM_STRING("APPEND"))
         return IMAP_APPEND;
      else if (sCommand == PLATFORM_STRING("STORE"))
         return IMAP_STORE;
      else if (sCommand == PLATFORM_STRING("COPY"))
         return IMAP_COPY;
      else if (sCommand == PLATFORM_STRING("EXAMINE"))
         return IMAP_EXAMINE;
      else if (sCommand == PLATFORM_STRING("SEARCH"))
         return IMAP_SEARCH;
      else if (sCommand == PLATFORM_STRING("RENAME"))
         return IMAP_RENAME;
      else if (sCommand == PLATFORM_STRING("AUTHENTICATE"))
         return IMAP_AUTHENTICATE;
      else if (sCommand == PLATFORM_STRING("CHECK"))
         return IMAP_CHECK;
      else if (sCommand == PLATFORM_STRING("GETQUOTAROOT"))
         return IMAP_GETQUOTAROOT;
      else if (sCommand == PLATFORM_STRING("GETQUOTA"))
         return IMAP_GETQUOTA;
      else if (sCommand == PLATFORM_STRING("IDLE"))
         return IMAP_IDLE;
      else if (sCommand == PLATFORM_STRING("SORT"))
         return IMAP_SORT;
      else if (sCommand == PLATFORM_STRING("NAMESPACE"))
         return IMAP_NAMESPACE;
      else if (sCommand == PLATFORM_STRING("MYRIGHTS"))
         return IMAP_MYRIGHTS;
      else if (sCommand == PLATFORM_STRING("GETACL"))
         return IMAP_GETACL;
      else if (sCommand == PLATFORM_STRING("DELETEACL"))
         return IMAP_DELETEACL;
      else if (sCommand == PLATFORM_STRING("SETACL"))
         return IMAP_SETACL;
      else if (sCommand == PLATFORM_STRING("LISTRIGHTS"))
         return IMAP_LISTRIGHTS;
      else if (sCommand == PLATFORM_STRING("STARTTLS"))
   ...
   //---------------------------------------------------------------------------()
   {
      ...
      int iSpace = sCommandValue.Find(PLATFORM_STRING(" "));
      String sCommandName = "";
      if (iSpace >= 0)
   ...
   void 
   IMAPConnection::SetRecentMessages(const std::set<long long> &messages)
   {
