...
#ifdef _WIN32 
	#ifdef _MSC_VER 
		#include <WinSock2.h>   // Systemheader for WinSock2
		#include <Windows.h>    // Systemheader for Windows
		#include <iphlpapi.h>   // Header for IP Helper-Functions
		#include <windns.h>     // Header for Windows DNS-Functions
	#endif	
#endif
...
//#include "../../hMailLibs/msvc/v143/x86_64/cares/include/ares.h"
